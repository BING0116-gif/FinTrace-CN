...
def test_collector_offline_is_flagged_synthetic_and_never_live(monkeypatch):
    ...
    p2 = collector.collect_daily_review(REVIEW_DATE, token=None, live=True, use_cache=False)
